...
export const FirstMicroPlate = () => {
    ...
    let { ref_numResponseMinStartingNum, ref_numResponseMaxStartingNum, sample_count, StartingNum, selected, setSelected, sampleLeftvers, setSampleLeftovers, blackList,blackListArray, setBlackListArray
		...
		<div ref={boardRef} className="board">
         ...
         <div>
            ...
            <div>container_type</div>
             ...
             <div>sampleLeftovers: {sampleLeftvers}</div>
             <div>StartingNum: {StartingNum}</div>
             <div>sample_count: {sample_count}</div>
         </div>
